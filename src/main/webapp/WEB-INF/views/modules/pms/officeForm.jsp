...
<body>
	...
	<shiro:lacksPermission name="sys:office:edit"> </shiro:lacksPermission>
		<li><a href="${ctx}/pms/office/">机构列表</a></li> 
		<li class="active"><a href="${ctx}/pms/office/form?id=${office.id}&parent.id=${office.parent.id}">机构${not empty office.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/pms/office/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <tags:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parent.name" labelValue="${office.parent.name}"
					title="机构" url="/pms/office/treeData" extId="${office.id}" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions"><shiro:hasPermission name="sys:office:edit"></shiro:hasPermission>
